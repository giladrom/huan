...
export class PermissionsPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,
    private ble: BleProvider, private fcm: FCM, private init: InitProvider) {
  }
  ...
  askLocationPermissions() {
    ...
    document.getElementById('location-button').style.background = 'linear-gradient(to top, #0ba360 0%, #3cba92 100%)';
  }
  ...
  askNotificationPermissions() {
    ...
    document.getElementById('notification-button').style.background = 'linear-gradient(to top, #0ba360 0%, #3cba92 100%)';
